                                        ...
                                        <form action="#">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="name"><h6>Teacher Name</h6></label>
                                                    <input type="text" class="form-control" id="addTeacher" placeholder="Teacher Name" autofocus required>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="course"><h6>Course Name</h6></label>
                                                    <input type="text" class="form-control" id="addCourse" placeholder="Course Nam" autofocus required>
                                                </div>
                                                <!-- <div class="form-group col-md-6">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6"><h6>From</h6>
                                                    <label for="Time"><h6>Time</h6></label>
                                                    <input type="time" class="form-control" id="addTime" placeholder="Time" autofocus required>
                                                </div>
                                                <div class="form-group col-md-6"><h6>To</h6>
                                                    <label for="Time"><h6>Time</h6></label>
                                                    <input type="time" class="form-control" id="addTime" placeholder="Time" autofocus required>
                                                </div>                                                
                                            </div>
