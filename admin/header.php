                        ...
                        <div class="navigation d-flex">
                            <ul class="navbar-nav nav-left">
                                ...
                                <li class="nav-item full-screen d-none d-lg-block" id="btnFullscreen">
                                    <a  id="navbarSupportedContent" class="nav-link expand">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon fa fa-graduation-cap"></i><span class="nav-title">Courses</span></a>
                                <ul aria-expanded="false">
                                    <li> <a href='edit-course.php'>Add Course</a> </li>
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false">
                                    <li> <a href='edit-facilty.php'>Add Faculty</a> </li>
                            ...
                            <li>
                                <a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon fa fa-calendar"></i> <span class="nav-title">Time-Table</span></a>
                                <ul aria-expanded="false">
                                    <li> <a href='#'>Add Time-Table</a> </li>
                                    <li> <a href='#'>List of Time-Tables</a> </li>
                                </ul>
                            </li>
                            <li>
                                <a href="#" aria-expanded="false"><i class="nav-icon fa fa-users"></i><span class="nav-title">Registration</span></a>
                            </li>
                            <li>
                                <a href="#l" aria-expanded="false"><i class="nav-icon fa fa-pencil-square-o"></i><span class="nav-title">Enquiry</span></a>
                            </li>
                            <li>
                                <a href="#" aria-expanded="false"><i class="nav-icon fa fa-envelope"></i><span class="nav-title">Contact Us</span></a>
                            </li>
                            <li>
                                <a href="#" aria-expanded="false"><i class="nav-icon fa fa-comment"></i><span class="nav-title">Feedback</span></a>
                            </li>
