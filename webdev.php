                ...
                <div class="col-12 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                    <p><strong>Topics Include:</strong>
                        <ol>
                            ...
                            <li>Elements, Attributes, Headings, Paragraphs</li>
                            <li>Formatting, Styles, Links, Images, Tables</li>
                            <li>Lists, Forms, Colors</li>
                            <li>HTML Advanced</li>
                            <li>Layout, Frames, Fonts</li>
                            <li>CSS, Entities, Head, Meta</li>
                            <li>URLs, Scripts, Events, Web server</li>
                        </ol>
                    </p>
                </div>
            </div>
