    ...
    <footer class="footer-area">
        ...
        <div class="bottom-footer-area">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script><a href="#"> Future Computers</a><br>Designed and Developed  by <a href="https://www.destovtech.com" target="_blank">Destov Tech</a></p>
                    </div>
                </div>
            </div>
        </div>
